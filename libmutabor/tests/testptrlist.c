...
int main() {
  ...
  list = MUT_NEW(ptrlist);
  fprintf(stderr,"insert o1\n");
  if(!MUT_VIRTCALL(ptrlist,list,insert)(list,o1)) assert(0);
  
  c1=MUT_VIRTCALL(ptrlist,list,tostring)(list);
  printf("%s\n",c1);
  free(c1);
  ...
  if(!MUT_VIRTCALL(ptrlist,list,insert)(list,o2)) assert(0);
  ...
  if(!MUT_VIRTCALL(ptrlist,list,insert)(list,s1)) assert(0);
  ...
  if(!MUT_VIRTCALL(ptrlist,list,insert)(list,s2)) assert(0);
  ...
  if(!MUT_VIRTCALL(ptrlist,list,insert)(list,s3)) assert(0);
  fprintf(stderr,"inserted s3\n");
