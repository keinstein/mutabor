...
\section{Geschichte von \protect\mutabor}
...
\part{Die Bedienelemente von \protect\mutabor}
...
\subsection{\protect\mutabor{} beenden}
\label{sec:MI_EXIT}
...
\subsection{Informationen über \protect\mutabor}
\label{sec:MI_ABOUT}
...
\chapter{Die Unterfenster von \protect\mutabor}\label{sec:DE_SUBWINDOW}
...
\part{Grundlagen der \protect\mutabor sprache}
\label{sec:SX_BASICS}
