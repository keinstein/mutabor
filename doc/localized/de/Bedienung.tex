...
\part{Überblick}
\chapter{Über \texorpdfstring{\mutabor}{Mutabor}}
...
\section{Geschichte von \texorpdfstring{\mutabor}{Mutabor}}
...
\part{Die Bedienelemente von \texorpdfstring{\mutabor}{Mutabor}}
...
\tracingcommands2\relax\tracingmacros2\relax
\begin{description}
...
\end{description}
\tracingcommands0\relax\tracingmacros0\relax
...
\item[save editor files (Quelltext sichern):] ist diese Option
  ...
  den \reflink{sec:DE_EDIT}{Editorfenstern} vor jedem aktivieren eines
  \reflink{sec:DV_LOGIKPROGRAMM}{Logikprogramms} gespeichert.  Das
...
\section{Gleichschwebende Stimmungen}
\label{sec:EX_EQUAL}
