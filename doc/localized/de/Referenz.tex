...
\helpsection{Sprachreferenz}{REFERENCE_LANGUAGE_REFERENCE}
...
\helpsection{Lexikalische-Konventionen}{REFERENCE_LEXICAL_CONVENTIONS}
...
\helpsection{Eingabesymbole}{REFERENCE_INPUT_SYMBOLS}
...
\helpsection{Kommentare}{REFERENCE_COMMENTS}
...
\helpsection{Namen}{REFERENCE_NAMES}
...
\helpsection{Reservierte-Woerter}{REFERENCE_RESERVED_WORDS}
\section{Reservierte Wörter}\label{sec:reservierte-worte}
\label{zweivier}
...
\helpsection{Zahlen}{REFERENCE_NUMBERS}
...
\helpsection{Syntax-Schreibweise}{REFERENCE_SYNTAX_DESCRIPTION}
...
\helpsection{Logikprogramm}{REFERENCE_LOGIC_PROGRAM}
...
\helpsection{Intervall}{REFERENCE_INTERVAL}
...
\helpsection{Ton}{REFERENCE_TONE}
...
\helpsection{Tonsystem}{REFERENCE_TONESYSTEM}
...
\helpsection{Umstimmung}{REFERENCE_RETUNING}
...
\helpsection{Harmonie}{REFERENCE_HARMONY}
...
\helpsection{Logik}{REFERENCE_LOGIC}
...
\helpsection{Ausloeser}{REFERENCE_TRIGGER}
...
\helpsection{Ausloeser-Taste}{REFERENCE_TRIGGER_KEYS}
\subsection{Taste}\index{Tasten}\label{sec:tasten}
...
\helpsection{Ausloeser-Harmonie}{REFERENCE_TRIGGER_HARMONY}
...
Wenn bei der Harmonie eine Bezugstaste\index{Bezugstaste} angegeben wurde, dann wird
...
Schlüsselwort \texttt{ANSONSTEN}\index{ANSONSTEN} gekennzeichnet. Dieser Zweig wird
...
\helpsection{Ausloeser-MIDI}{REFERENCE_TRIGGER_MIDI}
...
\helpsection{Aktionen}{REFERENCE_ACTION}
...
Schlüsselwort \emph{HARMONIEANALYSE}\index{HARMONIEANALYSE}. Eine erneute Harmonieanalyse ist nur
...
\helpsection{MIDI-Ausgaben}{REFERENCE_ACTION_MIDI_OUTUPUT}
...
\helpsection{MIDI-Kanaele}{REFERENCE_MIDI_CHANNELS}
