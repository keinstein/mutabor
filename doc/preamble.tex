...
%
\def\ts@end@parse{ts@end@parse@is@not@empty}%
\def\ts@parse@ref@a#1#2\ts@end@parse{\ts@parse@ref@b#1\ts@end@parse}
\def\ts@parse@ref@b#1#2\ts@end@parse{%
  \ifx\ts@end@parse#2\ts@end@parse\relax
   \expandafter#1\expandafter{\expandafter}%
  \else
   \expandafter\expandafter\expandafter#1%
   \expandafter{\ts@parse@ref@c#2\ts@end@parse}
  \fi
}
\def\ts@parse@ref@c#1#2\ts@end@parse{#2}
%
...
%
\newrobustcmd\mutabor[1][]{\texorpdfstring{\textsc{Mutabor#1}}{MUTABOR#1}}
%
