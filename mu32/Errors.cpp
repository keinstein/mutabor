...
/* 10 */ "Der Intervallname %s wurde doppelt benutzt",
         ...
         "Mehr als ein ANSONSTEN-Auslˆser in Logik %s",
...
/* 45 */ "MIDI-Kanal ung¸ltig (zul‰ssig: 1 bis 16)",
         ...
         "Taste %d liegt auﬂerhalb des Wertebereichs 24..108 (in Tonsystem %s)",
         ...
         "Als Taste eines Auslˆsers wurde kein einzelner Buchstabe angegeben TASTE %s",
...
/* Abh‰ngigkeiten */
/* 65 */ "Die Tˆne %s und %s h‰ngen gegenseitig voneinander ab",
...
/*  0 */ "Undefinierte Compilerwarnung",
         "MIDI-Auslˆser in Logik %s beginnt nicht mit Kanal 0- Statusbyte. "
                 "Wert wurde korrigiert!",
         "Unmˆglicher Harmonieauslˆser in Logik %s",
         "Mehrdeutiger Auslˆser %s in Logik %s",
         "Auslˆser ANSONSTEN ist nicht der letzte in Logik %s",
...
/*  0 */ N_("Undefined compiler warning"),
		...
		N_("Event ANSONSTEN is last in %s"),
