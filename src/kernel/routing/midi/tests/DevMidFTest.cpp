...
//	mutabor_debug_flags.midiio = true;
	...
	mutabor::CurrentTime = mutabor::microseconds(0);
...
//	mutabor::InputDeviceClass::BatchPlay();
	in -> Play();
	mutabor::microseconds delta = in -> PrepareNextEvent();
...
"0   0: 90 3c 7f\n"
	...
	CPPUNIT_ASSERT(delta == mutabor::microseconds(49920));
...
"0   3: 93 34 7f\n"
	...
	CPPUNIT_ASSERT(delta == mutabor::InputDeviceClass::NO_DELTA());
...
"99840000   2: c2 4f\n"
"99840000   2: 92 43 3f\n"
"149760000   2: 82 43 40\n"
"149760000   3: c3 4f\n"
"149760000   3: 93 34 7f\n"
"199680000   3: 83 34 40\n"
"249600000   0: 80 3c 7f\n"
"249600000 ...closed.\n"),__LINE__,(__FILE__)));
...
//	mutabor::InputDeviceClass::BatchPlay();
	...
	CPPUNIT_ASSERT(delta == mutabor::microseconds(1086));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(1954800));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(14725074));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(130320));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(130200));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(4769600));
...
"0   0: 90 3c 7f\n"
				  ...
				  __LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(6287200));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(845040));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(120000));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(123960));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(3222960));
...
"0   1: 91 40 1f\n"
	...
	CPPUNIT_ASSERT(delta == mutabor::microseconds(10330000));
...
"0   2: 92 43 3f\n"
	...
	CPPUNIT_ASSERT(delta == mutabor::microseconds(7809480));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(6100000));
...
"0   3: 93 34 7f\n"
	...
	CPPUNIT_ASSERT(delta == mutabor::microseconds(200000));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(146280));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(148080));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(150000));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(151800));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(153840));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(155760));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(157800));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(159960));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check((""),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(12104960));

	delta = in -> PrepareNextEvent();
	DEBUGLOG (midiio, "delta = %d" ,delta);
	CPPUNIT_ASSERT(out->Check(("0   3: 83 34 40\n"),__LINE__,(__FILE__)));
	CPPUNIT_ASSERT(delta == mutabor::microseconds(13510000));
...
"0  15: bf 06 02\n"
"0  15: bf 26 00\n"
"21711080000   0: 90 3c 7f\n"
"32310240000   1: 91 40 1f\n"
"42640240000   1: 81 40 40\n"
"52970240000   2: 92 43 3f\n"
"63300240000   2: 82 43 40\n"
"77209720000   3: 93 34 7f\n"
"90738200000   3: 83 34 40\n"
"104248200000   0: 80 3c 7f\n"
"104248200000 ...closed.\n"
),__LINE__,(__FILE__)));
...
,
			 file,
			 line,
			 MakePrintableC(s).c_str(),
			 MakePrintableC(tmp).c_str());
	}
	return retval;
}
...
//	std::clog << "Running setUp()" << std::endl;
	...
	out->SetName((DESTDIR  "/test_output.mid"));
	out->SetBendingRange(2);
	//out = new midicmnOutputDevice(3,("Test"));
...
"  2f /  00 ·\n"
	...
	CPPUNIT_ASSERT( in );
	in -> SetName((DESTDIR  "/test_output.mid"));
	out -> SetName((DESTDIR "/test_output2.mid"));
...
"  02 ·  00 ·  be ·  26 &  00 ·  00 ·  ef ·  00 ·    40 @  00 ·  bf ·  7a z  00 ·  00 ·  bf ·  7d }\n"
"  00 ·  00 ·  bf ·  7f ·  00 ·  00 ·  bf ·  65 e    00 ·  00 ·  bf ·  64 d  00 ·  00 ·  bf ·  06 ·\n"
"  02 ·  00 ·  bf ·  26 &  00 ·  81 ·  a9 ·  4f O    90 ·  3c <  7f ·  00 ·  b0 ·  65 e  00 ·  00 ·\n"
"  b0 ·  64 d  00 ·  d2 ·  67 g  91 ·  40 @  1f ·    00 ·  b1 ·  65 e  00 ·  00 ·  b1 ·  64 d  00 ·\n"
"  d0 ·  5a Z  81 ·  40 @  40 @  d0 ·  5a Z  92 ·    43 C  3f ?  00 ·  b2 ·  65 e  00 ·  00 ·  b2 ·\n"
"  64 d  00 ·  d0 ·  5a Z  82 ·  43 C  40 @  ec ·    56 V  93 ·  34 4  7f ·  00 ·  b3 ·  65 e  00 ·\n"
"  00 ·  b3 ·  64 d  00 ·  e9 ·  58 X  83 ·  34 4    40 @  e9 ·  46 F  80 ·  3c <  7f ·  00 ·  ff ·\n"
"  2f /  00 ·\n"
);
...
"0  15: bf 06 02\n"
"0  15: bf 26 00\n"
"0  -1: SysEx 01 00 7f 01 End\n"
"1000  -1: SysEx 7e 01 7f 03 End\n"
"2000  -1: SysEx 7e 0a 7e 02 End\n"
"3000  -1: SysEx 7e 00 01 02 7d 04 End\n"
"4000  -1: SysEx 7e 00 03 04 7c 05 End\n"
"5000  -1: SysEx 7e 02 7b 06 End\n"
"6000  -1: SysEx 7e 03 01 23 45 08 01 00 00 02 00 00 00 00 00 02 00 00 01 End\n"
"7000  -1: SysEx 7e 04 03 01 23 End\n"
"8000  -1: SysEx 7e 05 02 07 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 7e End\n"
"9000  -1: SysEx 7e 06 05 01 23 45 01 02 01 01 00 00 02 00 00 End\n"
"10000  -1: SysEx 7e 07 05 02 23 45 01 00 End\n"
"11000  -1: SysEx 7e 08 06 01 End\n"
"12000  -1: SysEx 7e 09 06 02 08 7e 6d 5c 4b 00 04 00 00 End\n"
"546000 ...closed.\n"
),__LINE__,(__FILE__)));
