...
/**
 ** \file y.tab.h
 ** Define the mutabor::scala_parser::parser class.
 */
...
#line 132 "../../../mutabor-git/src/kernel/parsers/scala/scale_parser.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_F_NUMBER (const std::string& v, const location_type& l);
  ...
  private:
    ...
    scale_parser (const scale_parser&);
    scale_parser& operator= (const scale_parser&);
  ...
  inline
  scale_parser::token_number_type
  scale_parser::yytranslate_ (token_type t)
  {
    static
  ...
  inline
  scale_parser::syntax_error::syntax_error (const location_type& l, const std::string& m)
    : std::runtime_error (m)
    , location (l)
  {}
  ...
  template <typename Base>
  inline
  scale_parser::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
  ...
  template <typename Base>
  inline
  scale_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {
  ...
  template <typename Base>
  scale_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {}
  ...
  template <typename Base>
  scale_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const double v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  scale_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const int32_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  scale_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const scala_parser::interval v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  inline
  void
  scale_parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move(s);
      switch (this->type_get ())
    {
  ...
  inline
  scale_parser::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
  scale_parser::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}
  ...
  inline
  int
  scale_parser::by_type::type_get () const
  {
    return type;
  }

  inline
  scale_parser::token_type
  scale_parser::by_type::token () const
  {
  ...
  scale_parser::make_END (const location_type& l)
  {
    return symbol_type (token::SCALA_TOKEN_END, l);
  }
  ...
  scale_parser::symbol_type
  scale_parser::make_F_NUMBER (const std::string& v, const location_type& l)
  {
    return symbol_type (token::SCALA_TOKEN_F_NUMBER, v, l);
  }

  scale_parser::symbol_type
  scale_parser::make_INTEGER (const std::string& v, const location_type& l)
  {
    return symbol_type (token::SCALA_TOKEN_INTEGER, v, l);
  }

  scale_parser::symbol_type
  scale_parser::make_SPACE (const std::string& v, const location_type& l)
  {
...
#line 1380 "../../../mutabor-git/src/kernel/parsers/scala/scale_parser.hh" // lalr1.cc:377
